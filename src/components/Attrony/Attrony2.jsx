          ...
          <div className="row justify-content-center">
            <div className="col-xl-5 col-lg-6 col-md-8 col-sm-10">
              <div className="section-title2 text-center">
                ...
                <h2>Find the best real estate professional for your needs.</h2>
              </div>
            </div>
          </div>
                ...
                <div className="swiper-wrapper">
                  ...
                  >
                    <div className="attorney-single sibling2">
                      <img
                        src="assets/images/bg/attorney21.png"
                  ...
                  >
                    <div className="attorney-single sibling2">
                      <img
                        src="assets/images/bg/attorney22.png"
                        className="casestudy1"
                        alt="image"
                      />
                      <div className="content">
                  ...
                  >
                    <div className="attorney-single sibling2">
                      <img
                        src="assets/images/bg/attorney23.png"
                        className="casestudy1"
                        alt="image"
                      />
                      <div className="content">
                  ...
                  >
                    <div className="attorney-single sibling2">
                      <img
                        src="assets/images/bg/attorney24.png"
                        className="casestudy1"
                        alt="image"
                      />
                      <div className="content">
