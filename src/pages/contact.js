...
import { getAllContactApi } from "../services/userService"; // Adjust path to your API file

function Contact() {
  // 1. Use the useFetch hook by passing the API method
  const { data, loading, fetchData } = useFetch(getAllContactApi);
  ...
  // 3. Since data is normalized to an array, we get the first item
