...
//   const [expandedId, setExpandedId] = useState(null); // State to handle Read More
      ...
      <section className="container py-5">
        <div className="row g-4 justify-content-center">
          {properties.map((item) => {
            ...
            const displayImage =
              item.photos?.[0]?.url || "/assets/images/bg/sale1.jfif";
            ...
            return (
              <div key={item.id} className="col-lg-4 col-md-6 d-flex">
                <div
                  className="card w-100 border-0 shadow-sm d-flex flex-column"
                  style={{ borderRadius: "0px" }}>
                  ...
                  <div className="card-body p-4 d-flex flex-column flex-grow-1">
                    <h5 className="fw-bold mb-2" style={{ minHeight: "44px" }}>
                      {displayAddress}
                    </h5>
                    ...
                    {item.geolocation?.latitude && (
                      <a
                        ...
                        style={{ color: "#0a5863", fontSize: "12px" }}>
                        <i className="bi bi-geo-alt-fill"></i> View on Map
                      </a>
                    )}
                    ...
                    <div className="flex-grow-1">
                      <p className="text-muted small">
                        {expandedId === item.id ? item.description : shortDesc}
                      </p>
                      {isLong && (
                        <button
                          onClick={() =>
                          ...
                          className="btn btn-link p-0 mb-3 text-decoration-none small fw-bold"
                          style={{ color: "#0a5863" }}>
                    ...
                    <div className="d-flex gap-3 border-top pt-3 text-muted small mt-auto">
                      <span>
                        <strong>Beds</strong> {item.bed || 0}
                      </span>
                      <span>
                        <strong>Baths</strong> {item.bath || 0}
                      </span>
                    </div>
                  </div>
                </div>
